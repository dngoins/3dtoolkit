...
OpenGLBufferCapturer::OpenGLBufferCapturer(UINT width, UINT height)
{
	buffer_width = width;
	buffer_height = height;
}

void OpenGLBufferCapturer::Initialize()
{
...
void OpenGLBufferCapturer::SendFrame(webrtc::VideoFrame video_frame)
{
	if (!running_)
	{
		return;
	...
	// Sending video frame.
	BufferCapturer::SendFrame(video_frame);
}
